...
namespace SalesApi.DataContext.Migrations
{
    ...
    [Migration("20180112003601_AddSubscriptionPromotionDeliveryDate")]
    partial class AddSubscriptionPromotionDeliveryDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SubscriptionPromotions");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SubscriptionPromotionId");
                    ...
                    b.HasIndex("SubscriptionPromotionId", "Year", "Month")
                        .IsUnique();

                    b.ToTable("SubscriptionPromotionMonths");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonthBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SubscriptionPromotionMonthId");
                    ...
                    b.HasIndex("SubscriptionPromotionMonthId", "ProductForSubscriptionId", "DayBonusCount")
                        .IsUnique();

                    b.ToTable("SubscriptionPromotionMonthBonuses");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonthBonusDeliveryDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SubscriptionPromotionMonthBonusId");
                    ...
                    b.HasIndex("SubscriptionPromotionMonthBonusId", "Date")
                        .IsUnique();

                    b.ToTable("SubscriptionPromotionMonthBonusDeliveryDates");
                });
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonth", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.Promotion.SubscriptionPromotion", "SubscriptionPromotion")
                        .WithMany("SubscriptionPromotionMonths")
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonthBonus", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonth", "SubscriptionPromotionMonth")
                        .WithMany("SubscriptionPromotionMonthBonuses")
                        .HasForeignKey("SubscriptionPromotionMonthId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonthBonusDeliveryDate", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.Promotion.SubscriptionPromotionMonthBonus", "SubscriptionPromotionMonthBonus")
                        .WithMany("SubscriptionPromotionMonthBonusDeliveryDates")
                        .HasForeignKey("SubscriptionPromotionMonthBonusId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
