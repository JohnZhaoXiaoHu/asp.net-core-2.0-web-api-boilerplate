...
namespace SalesApi.DataContext.Migrations
{
    ...
    [Migration("20180108021802_AddSubscriptionPromotions")]
    partial class AddSubscriptionPromotions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SubscriptionPromotionSeriesId");
                    ...
                    b.HasIndex("SubscriptionPromotionSeriesId");

                    b.HasIndex("ProductForSubscriptionId", "Date")
                        .IsUnique();

                    b.ToTable("SubscriptionPromotionEvent");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionEventBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SubscriptionPromotionEventId");
                    ...
                    b.HasIndex("SubscriptionPromotionEventId");

                    b.ToTable("SubscriptionPromotionEventBonus");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SubscriptionPromotionSeries");
                });

            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionSeriesBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SubscriptionPromotionSeriesBonus");
                });
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionEvent", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.ProductForSubscription", "ProductForSubscription")
                        .WithMany("SubscriptionPromotionEvents")
                        .HasForeignKey("ProductForSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SalesApi.Models.Subscription.SubscriptionPromotionSeries", "SubscriptionPromotionSeries")
                        .WithMany("SubscriptionPromotionEvents")
                        .HasForeignKey("SubscriptionPromotionSeriesId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionEventBonus", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.ProductForSubscription", "ProductForSubscription")
                        .WithMany("SubscriptionPromotionEventBonuses")
                        .HasForeignKey("ProductForSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SalesApi.Models.Subscription.SubscriptionPromotionEvent", "SubscriptionPromotionEvent")
                        .WithMany("SubscriptionPromotionEventBonuses")
                        .HasForeignKey("SubscriptionPromotionEventId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionSeries", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.ProductForSubscription", "ProductForSubscription")
                        .WithMany("SubscriptionPromotionSeries")
                        .HasForeignKey("ProductForSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("SalesApi.Models.Subscription.SubscriptionPromotionSeriesBonus", b =>
                {
                    b.HasOne("SalesApi.Models.Subscription.ProductForSubscription", "ProductForSubscription")
                        .WithMany("SubscriptionPromotionSeriesBonuses")
                        .HasForeignKey("ProductForSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
